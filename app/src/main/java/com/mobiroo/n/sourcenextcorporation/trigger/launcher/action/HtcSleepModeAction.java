 ...
 */
public class HtcSleepModeAction extends BaseAction {
    private String[] SETTINGS = { "smartsync_night_mode_enable"};
    ...
    int title = R.string.htc_sleep_mode;
