 ...
 */
public class SamsungHandsFreeAction extends BaseAction {

    private String[] SETTINGS = { "driving_mode_on", "voice_input_control"};
    ...
    int title = R.string.samsung_hands_free;

    @Override
    public String getCommand() {
        return Constants.COMMAND_SAMSUNG_HANDS_FREE;
    }

    @Override
    public String getCode() {
        return Codes.SAMSUNG_HANDS_FREE;
    }
    ...
    public String getName() {
        return "Samsung Hands Free Mode";
    }
