 ...
 */
public class HtcPowerSaverAction extends BaseAction {
    private String[] SETTINGS = { "user_powersaver_enable", "STATUS_POWER_SAVING_AUTO"};

    private List<int[]> VALUES = new ArrayList<int[]>()
    {
        {
            add(new int[] { 0, 1});
            add(new int[] { 8000, 8002});
        }
    };

    int title = R.string.htc_power_saver;

    @Override
    public String getCommand() {
        return Constants.COMMAND_HTC_POWER_SAVER;
    }

    @Override
    public String getCode() {
        return Codes.HTC_POWER_SAVER;
    }
