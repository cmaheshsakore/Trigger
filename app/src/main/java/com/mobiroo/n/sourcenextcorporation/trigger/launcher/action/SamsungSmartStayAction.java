 ...
 */
public class SamsungSmartStayAction extends BaseAction {
    private String[] SETTINGS = { "intelligent_sleep_mode"};
    ...
    int title = R.string.samsung_smart_stay;

    @Override
    public String getCommand() {
        return Constants.COMMAND_SAMSUNG_SMART_STAY;
    }

    @Override
    public String getCode() {
        return Codes.SAMSUNG_SMART_STAY;
    }
