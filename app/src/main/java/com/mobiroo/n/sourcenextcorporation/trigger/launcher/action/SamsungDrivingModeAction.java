...
public class SamsungDrivingModeAction extends BaseAction {

    private final String SAMSUNG_DRIVING_MODE = "driving_mode_on";
    private final String SAMSUNG_CAR_MODE = "car_mode_on";
    private final String SAMSUNG_DRIVING_LINK = "drive_link_setting";

    @Override
    public String getCommand() {
        return Constants.COMMAND_SAMSUNG_DRIVING_MODE;
    }

    @Override
    public String getCode() {
        return Codes.SAMSUNG_DRIVING_MODE;
    }
    
    @Override
    public View getView(Context context, CommandArguments arguments) {
        LayoutInflater inflater = getLayoutInflater(context);
        View dialogView = inflater.inflate(R.layout.configuration_dialog_option056, null, false);
    ...
    public String[] buildAction(View actionView, Context context) {
        ...
        String item = context.getString(R.string.display_driving_mode);
        ...
        message += Constants.COMMAND_SAMSUNG_DRIVING_MODE;
    ...
    public String getDisplayFromMessage(String command, String[] args, Context context) {
        return context.getString(R.string.display_driving_mode);
    }
    ...
    public void performAction(Context context, int operation, String[] args, int currentIndex) {
        Logger.d("Samsung Driving Mode");
        Utils.operateGeneralSetting(context, operation, SAMSUNG_DRIVING_MODE);
        Utils.operateGeneralSetting(context, operation, SAMSUNG_CAR_MODE);
        Utils.operateGeneralSetting(context, operation, SAMSUNG_DRIVING_LINK);
    }

    @Override
    public String getWidgetText(Context context, int operation) {
        return getBaseWidgetSettingText(context, operation, context.getString(R.string.driving_mode));
    }

    @Override
    public String getNotificationText(Context context, int operation) {
        return getBaseActionSettingText(context, operation, context.getString(R.string.driving_mode));
    }
