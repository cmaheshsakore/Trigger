 ...
 */
public class HtcBoomSoundAction extends BaseAction {
    private String[] SETTINGS = { "audio.soundenhancer.effect"};
    ...
    int title = R.string.htc_boom_sound;

    @Override
    public String getCommand() {
        return Constants.COMMAND_HTC_BOOM_SOUND;
    }

    @Override
    public String getCode() {
        return Codes.HTC_BOOM_SOUND;
    }
