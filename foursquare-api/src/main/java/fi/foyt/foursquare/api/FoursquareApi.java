...
public class FoursquareApi {
  ...
  private static final String DEFAULT_VERSION = "20131016";
   ...
   * @throws FoursquareApiException when something unexpected happens
   */
  public Result<VenuesSearchResult> venuesSearch(String ll, Double llAcc, Double alt, Double altAcc, String query, Integer limit, String intent, String categoryId, String url, String providerId, String linkedId, String near) throws FoursquareApiException {
    try {
      ApiRequestResponse response = doApiRequest(Method.GET, "venues/search", isAuthenticated(), "ll", ll, "llAcc", llAcc, "alt", alt, "altAcc", altAcc, "query", query, "limit", limit, "intent", intent, "categoryId", categoryId, "url", url, "providerId", providerId, "linkedId", linkedId, "near", near);
      VenuesSearchResult result = null;

        Log.d("NFCT", "FOURSQUARE Response is " + response.getResponse().toString());
